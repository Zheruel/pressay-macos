...
/// Conservative defaults for Slack messages and agent-driven software work.
/// Common English words with technical meanings (for example Go, React, REST,
/// Linear, and Terminal) are intentionally omitted because global rewriting
/// would corrupt ordinary messages.
package enum CuratedVocabulary {
    ...
    /// Exact stock defaults from earlier builds. Only these are replaced during
    /// migration; any user-edited vocabulary remains untouched.
