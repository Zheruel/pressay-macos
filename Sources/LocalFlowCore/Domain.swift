...
/// The local speech-to-text model powering dictation. Defaults and captions
/// come from a 184-clip corpus comparison against production transcripts
/// (see LocalFlowBench + the transcribe.cpp evaluation).
